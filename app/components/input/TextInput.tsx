...
const TextInput: React.FC<TextInputProps> = ({ id, label, type = "text", register, errors }) => {
    return (
        <>
            <div className="relative w-full min-w-[200px] h-10">
                ...
                {/* <input
                    ...
                    type={type}
                    className={`peer w-full h-full bg-transparent text-gray-700 font-sans font-normal outline outline-0 focus:outline-0 disabled:bg-blue-gray-50 disabled:border-0 transition-all placeholder-shown:border placeholder-shown:${errors[id] ? "border-red-500" : "border-gray-200"} placeholder-shown:${errors[id] ? "border-t-red-500" : "border-t-gray-200"} border focus:border-2 border-t-transparent focus:border-t-transparent text-sm px-3 py-2.5 rounded-[7px] ${errors[id] ? "border-red-500" : "border-gray-200"} focus:${errors[id] ? "border-red-500" : "border-gray-900"}`}
                    placeholder=""
                /> */}
